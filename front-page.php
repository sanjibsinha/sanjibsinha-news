<?php get_header(); ?>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="d-flex position-relative  float-left">
                  <h3 class="section-title">রান্নাঘর</h3>
                </div>
              </div>
            </div>
      ...
      <div class="row">
          ...
          <div class="row">
              <div class="col-lg-3">
                <div class="d-flex position-relative float-left">
                  <h3 class="section-title">পাঁচফোড়ন</h3>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6  mb-5 mb-sm-2">
                ...
                <?php 
                  ...
                  <div class="position-relative image-hover">
                  <img class="illustration"
                    alt="bengali-news" src="<?php if ( has_post_thumbnail() ) { the_post_thumbnail( 'large' ); } ?>" />
          ...
          <div class="popular-news">
            <div class="row">
              <div class="col-lg-3">
                <div class="d-flex position-relative float-left">
                  <h3 class="section-title">ঝোলেঝালেঅম্বলে</h3>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="d-flex position-relative float-left">
                      <h3 class="section-title">মিস্টিমুখ</h3>
                    </div>
                  </div>
                  <?php 
          ...
          <div class="world-news">
            <div class="row">
              <div class="col-sm-12">
                <div class="d-flex position-relative  float-left">
                  <h3 class="section-title">পরিবেশ-ন</h3>
                </div>
              </div>
            </div>
